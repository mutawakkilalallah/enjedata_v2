    ...
    <div class="login-box text-center">
        ...
        <div class="card card-outline card-navy">
            <div class="card-header text-center">
                ...
                <br>
                <a href="/login" class="h1 text-navy"><b>ENJEDATA</a>
            </div>
            <div class="card-body">
                <form action="/login" method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button type="submit" class="btn bg-navy btn-block"><i class="fas fa-sign-in-alt"></i>
                                Login</button>
                        </div>
                        <div class="col-6">
                            <a href="/walisantri" class="btn bg-maroon btn-block"><i class="fas fa-blind"></i>
                                Wali Santri</a>
                        </div>
                    </div>
                </form>
