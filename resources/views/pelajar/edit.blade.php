    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form action="/pelajar/{{ $pelajar->pelajar_id }}/update" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nisn') is-invalid @enderror"
                                id="nisn" value="{{ old('nisn') ? old('nisn') : $pelajar->nisn }}" name="nisn"
                                autocomplete="off">
                            @error('nisn')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm @error('lembaga_id') is-invalid @enderror"
                                ...
                                <option value="{{ $pelajar->lembaga_id }}" selected>{{ $pelajar->lembaga_nama }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm @error('kelas_id') is-invalid @enderror"
                                ...
                                <option value="{{ $pelajar->kelas_id }}" selected>{{ $pelajar->kelas_nama }}</option>
                            </select>
                            @error('kelas_id')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <input type="hidden" name="uuid" value="{{ $pelajar->person_uuid }}">
