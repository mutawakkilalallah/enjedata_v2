    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form action="/person/{{ $p->uuid }}/update" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('no_kk') is-invalid @enderror"
                                id="no_kk" value="{{ old('no_kk') ? old('no_kk') : $p->no_kk }}" name="no_kk"
                                autocomplete="off">
                            @error('no_kk')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nik') is-invalid @enderror"
                                id="nik" value="{{ old('nik') ? old('nik') : $p->nik }}" name="nik"
                                autocomplete="off">
                            @error('nik')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nama') is-invalid @enderror"
                                id="nama" value="{{ old('nama') ? old('nama') : $p->nama }}" name="nama"
                                autocomplete="off">
                            @error('nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                id="tempat_lahir" value="{{ old('tempat_lahir') ? old('tempat_lahir') : $p->tempat_lahir }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="date"
                                    ...
                                    id="tanggal_lahir"
                                    value="{{ old('tanggal_lahir') ? old('tanggal_lahir') : $p->tanggal_lahir }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm @error('jenis_kelamin') is-invalid @enderror"
                                ...
                                <option value="{{ $p->jenis_kelamin }}" selected>
                                    {{ $p->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('prov_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $p->prov_id }}" selected>{{ $p->prov_name }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('kab_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $p->kab_id }}" selected>{{ $p->city_name }}</option>
                                    </select>
                                    @error('kab_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('kec_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $p->kec_id }}" selected>{{ $p->dis_name }}</option>
                                    </select>
                                    @error('kec_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('desa_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $p->desa_id }}" selected>{{ $p->subdis_name }}</option>
                                    </select>
                                    @error('desa_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('jalan') ? old('jalan') : $p->jalan }}" name="jalan" autocomplete="off">
                            @error('jalan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                id="kode_pos" value="{{ old('kode_pos') ? old('kode_pos') : $p->kode_pos }}"
